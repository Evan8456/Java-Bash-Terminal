...
public class InvalidPathException extends Exception {
  ...
  /**
   * Creates the InvalidPathException, which is to be used when the user passes
   * an invalid path or a path that does not exist
   */

  public InvalidPathException() {
    super("Given path does not exist or is not valid");
  }


  /**
   * Creates the InvalidPathException with the given message
   *
   * @param message The message to be returned when the exception is thrown
   */
  public InvalidPathException(String message) {
    super("Given path \"" + message + "\" does not exist or is not valid");
  }
